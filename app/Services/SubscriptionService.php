...
final class SubscriptionService extends Model
{
    ...
    public function userHasActiveSubscription(int $userId): bool { return $this->getDaysRemaining($userId) > 0; }
    public function canUseSwipe(int $userId): bool { return $this->userHasActiveSubscription($userId); }
    public function canSendMessages(int $userId): bool { return $this->userHasActiveSubscription($userId); }
    public function canSeeMatches(int $userId): bool { return $this->userHasActiveSubscription($userId); }
}
