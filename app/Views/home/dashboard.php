...
<div class="rd-card mb-3"><div class="card-body">
  ...
  <?php if (($dailyRoute['can_claim_reward'] ?? false) === true): ?><span class="badge text-bg-success">Recompensa pronta para resgate</span>
  <?php elseif ((int) ($dailyRoute['progress_total'] ?? 0) > 0 && ((int) ($dailyRoute['progress_total'] ?? 0) - (int) ($dailyRoute['progress_completed'] ?? 0) === 1)): ?><span class="badge text-bg-warning">Falta só 1 passo</span>
  <?php endif; ?>
</div></div>
<?php endif; ?>
