...
<form method="post" action="/messages/send" class="d-flex gap-2"><input class="form-control" name="message_text" placeholder="Digite sua mensagem"><button class="btn btn-rd-primary"><i class="fa-solid fa-paper-plane"></i></button></form>
