<?php $events = $events ?? []; $filters = $filters ?? []; $pagination = $pagination ?? ['page' => 1, 'total_pages' => 1, 'total' => 0, 'per_page' => 50]; ?>
...
<thead><tr><th>Quando</th><th>Actor</th><th>Acção</th><th>Alvo</th><th>Metadata</th></tr></thead>
<tbody>
<?php foreach ($events as $event): ?>
<tr>
  <td><?= e((string) $event['created_at']) ?></td>
  <td><?= e((string) ($event['admin_name'] ?? (($event['actor_type'] ?? 'actor') . '#' . ($event['actor_id'] ?? 'n/a')))) ?></td>
