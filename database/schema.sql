...
CREATE TABLE IF NOT EXISTS posts (
  ...
  post_mood VARCHAR(80) NULL,
  relational_phase VARCHAR(80) NULL,
  origin_type VARCHAR(40) NOT NULL DEFAULT 'normal',
  created_at DATETIME NOT NULL,
  updated_at DATETIME NOT NULL,
  ...
  INDEX idx_posts_origin_created (origin_type, created_at),
  INDEX idx_posts_mood_phase (post_mood, relational_phase, created_at)
);
...
CREATE TABLE IF NOT EXISTS post_comments (
  ...
  INDEX idx_post_comments_post_user (post_id, user_id, created_at),
...
CREATE TABLE IF NOT EXISTS post_reactions (
  ...
  INDEX idx_post_reactions_user_post (user_id, post_id)
);
...
CREATE TABLE IF NOT EXISTS post_poll_votes (
  ...
  INDEX idx_post_poll_votes_user_poll (user_id, poll_id)
);
