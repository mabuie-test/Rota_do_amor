...
$router->add('GET', '/admin/users/{id}', [AdminUserController::class, 'index'], $adminGuard);
$router->add('POST', '/admin/users/{id}/status', [AdminUserController::class, 'index'], $adminGuard);
$router->add('POST', '/admin/users/{id}/resend-verification-email', [AdminUserController::class, 'index'], $adminGuard);
...
$router->add('POST', '/admin/verifications/{id}/approve', [AdminVerificationController::class, 'index'], $adminGuard);
$router->add('POST', '/admin/verifications/{id}/reject', [AdminVerificationController::class, 'index'], $adminGuard);
$router->add('GET', '/admin/reports', [AdminReportController::class, 'index'], $adminGuard);
$router->add('POST', '/admin/reports/{id}/resolve', [AdminReportController::class, 'index'], $adminGuard);
